    ...
    <div>
        ...
        <div v-else>
            <div v-if="isMoreThanOneRowsOfAccessories">
                ...
                <!-- three rows -->
                <accessories-row :class="{'center-elts': isMoreThanOneRowsOfAccessories}"
                                 v-if=" typeof splitedArray[2] != undefined">
                    <base-accessorie-card
