...
@section('content')    
        ...
        <div class="page_center">
            <div class="row anim">
                <div class="col_2_3_xl col_1_m">
                    <figure class="section_figure anim3"><img alt="Product" src="img/product.jpg" /></figure>
                </div>
                <div class="col_1_3_xl col_1_m">
                    <div class="section_content">
                        ...
                        <div class="section_form">
                            <button
                                class="snipcart-add-item button button_blue_solid"
    ...
    <section class="gallery_section">
        ...
        <div class="section_body clearfix anim">
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay1">
                <figure class="item_figure"><img src="img/mil_std.jpg" alt="MIL-STD-810G" /></figure>
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay2">
                <figure class="item_figure"><img src="img/waterproof.jpg" alt="WATERPROOF" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay3">
                <figure class="item_figure"><img src="img/shockproof.jpg" alt="SHOCKPROOF" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay4">
                <figure class="item_figure"><img src="img/dustproof.jpg" alt="DUSTPROOF" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay5">
                <figure class="item_figure"><img src="img/your_passion.jpg" alt="YOUR PASSION" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay6">
                <figure class="item_figure"><img src="img/running.jpg" alt="RUNNING" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay7">
                <figure class="item_figure"><img src="img/adventures.jpg" alt="ADVENTURES" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay8">
                <figure class="item_figure"><img src="img/ram_mounts.jpg" alt="RAM MOUNTS" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay9">
                <figure class="item_figure"><img src="img/cycling.jpg" alt="CYCLING" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay10">
                <figure class="item_figure"><img src="img/dashcam.jpg" alt="DASHCAM MODE" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay11">
                <figure class="item_figure"><img src="img/tough_job.jpg" alt="TOUGH JOB" /></figure>
                <div class="item_content">
            ...
            <div class="item col_3_xl col_2_m col_1_xs anim1 delay12">
                <figure class="item_figure"><img src="img/navigation.jpg" alt="NAVIGATION" /></figure>
                <div class="item_content">
    ...
    <section class="mount_section">
        <div class="page_center">
            <video autoplay loop muted playsinline  class="section_video" inline>
                <source src="img/mount.mp4" type="video/mp4">
            </video>
    ...
    <section id="ram_section" class="ram_section">
        <div id="ram_section_bg" class="section_bg">
            <div class="section_icons_ram">
                <img src="img/icon_ram.png" alt="">
                <img src="img/icon_usa.png" alt="">
            </div>
        </div>
        <div class="page_center">
            <div class="section_content">
    ...
    <section class="screen_section">
        <div class="page_center anim">
            <figure class="section_figure anim4"><img alt="Screen" src="img/screen.jpg" /></figure>
            ...
            <div class="section_chart">
                <img src="img/screen_chart.png" alt="Screen chart" />
            </div>
        </div>
    </section>
    <section id="battery_section" class="battery_section">
        ...
        <div class="page_center">
            <div class="section_content">
                ...
                <figure class="section_figure anim"><img alt="Battery" src="img/battery1.png" /><img class="overlay anim2 delay2" src="img/battery2.png" /></figure>
            </div>
        </div>
    </section>
    <section class="specs_section">
        <div class="page_center">
            <div class="section_header"><a id="specs_link" class="hover" href="javascript:void(0)">View full technical specs&emsp;<svg class="icon"><use id="specs_link_icon" xlink:href="img/icons.svg#icon_plus"></use></svg></a></div>
    ...
    <section class="charging_section">
        <div class="page_center">
            <div class="row anim">
                ...
                <div class="col_2_xl col_1_s">
                    <figure class="section_figure anim5"><img alt="Charging" src="img/charging.jpg" /></figure>
                </div>
            </div>
        </div>
    </section>
    <section class="video_section">
        <div class="section_center">
            <video id="designed_video" class="section_video" controls="controls">
                <source src="img/designed.mp4" type="video/mp4">
            </video>
        ...
        <div class="page_center">
            <div class="row anim">
                ...
                <div class="col_1_3_xl col_1_m">
                    ...
                    <figure class="section_figure anim3"><img alt="Product" src="img/Lynx_with_screen.png" /></figure>
                </div>
                <div class="col_1_3_xl col_1_m call_to_actions">
                    <div class="section_content">
                        ...
                        <div class="section_cta">
<!--						    <a href="#" class="store_cta getnord_store"><img src="./img/getnord_logo.png" alt=""></a>-->
                            <button
