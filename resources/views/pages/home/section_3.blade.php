<section class="gallery_section">
    <div class="section_header">{{ __('home.workAndAdventure') }}</div>
    <div class="section_body clearfix anim">
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay1">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure1') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure1Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay2">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure2') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure2Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay3">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure3') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure3Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay4">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure4') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure4Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay5">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure5') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure5Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay6">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure6') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure6Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay7">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure7') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure7Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay8">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure8') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure8Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay9">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure9') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure9Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay10">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure10') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure10Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay11">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure11') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure11Text') }}</div>
            </div>
        </div>
        <div class="item col_3_xl col_2_m col_1_xs anim1 delay12">
            ...
            <div class="item_content">
                <div class="item_heading">{{ __('home.workAndAdventure12') }}</div>
                <div class="item_description">{{ __('home.workAndAdventure12Text') }}</div>
            </div>
        </div>
    </div>
</section>