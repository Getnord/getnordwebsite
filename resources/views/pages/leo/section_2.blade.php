    ...
    <div class="page_center">
        <div class="row anim">
            <div class="col_2_3_xl col_1_m">
                ...
                <figure class="section_figure anim3"><img alt="Product" src="{{ url('/') }}/img/leo/getnord_leo_all_sides.png" /></figure>
            </div>
            <div class="col_1_3_xl col_1_m">
                <div class="section_content">
                    ...
                    <div class="section_form">
                        <buy-btn product-id="68" @buy-btn-clicked="buybtnclicked" :product-has-options="false" class="button button_yellow button--full-width">
                            {{ __('leo.addToCart') }}
                        </buy-btn>
