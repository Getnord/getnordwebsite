<section class="mount_section mount_section--dark">
    <img src="{{ url('/') }}/img/onyx/getnord_onyx_in_debris.jpg" alt="" class="section_img">
    <div class="page_center">
        <div class="section_heading">{{ __('onyx.metalReinforced') }}</div>
        ...
        <div class="section_icons anim">
            ...
            <span class="anim1 delay3 icons--responsive">
                ...
                <p class="icon_text">{{ __('onyx.metalReinforcedFlex') }}</p>
            </span>
            <span class="anim1 delay4 icons--responsive">
                <img src="{{ url('/') }}/img/onyx/icons/carabiner-clip-icon.svg" alt="">
                <p class="icon_text">{{ __('onyx.metalReinforcedCarabiner') }}</p>
            </span>
        </div>
    </div>
</section>